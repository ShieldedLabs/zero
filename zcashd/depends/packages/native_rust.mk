...
$(package)_sha256_hash_x86_64_linux=c1130e4f7976f230766ab062b105b1fb050d6a78177db2246a5878fd6a589680
...
$(package)_sha256_hash_x86_64_darwin=ddaf6a98ccc500891a74bcb95807a04c89a0d1ad7b9c58bd7116620ff6f903a8
...
$(package)_sha256_hash_x86_64_freebsd=5457c15df17ff963b582b95c55fae3bc3736468e4df765182c75c19b1b6e8e74

# Mapping from GCC canonical hosts to Rust targets.
# GCC Darwin hosts contain a Darwin version suffix, while Rust targets do not.
...
define rust_target
$(if $($(1)_rust_target_$(2)),$($(1)_rust_target_$(2)),$(if $(findstring darwin,$(3)),$(word 1,$(subst -, ,$(2)))-apple-darwin,$(if $(findstring freebsd,$(3)),$(word 1,$(subst -, ,$(2)))-unknown-freebsd,$(2))))
endef
