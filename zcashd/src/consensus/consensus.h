...
/** The minimum allowed ZIP 229 transaction version (network rule) */
static const int32_t ZIP229_MIN_TX_VERSION = 6;
/** The maximum allowed ZIP 229 transaction version (network rule) */
static const int32_t ZIP229_MAX_TX_VERSION = 6;
