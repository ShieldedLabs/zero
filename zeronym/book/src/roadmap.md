...
- **A deliberate 80% first step.** IP unlinking for the migration is the bulk of the practical privacy at stake in the acute window; query privacy and the deshield/shield cases are the remaining margin, which costs exponentially more to close.
